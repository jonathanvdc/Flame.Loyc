...
type NodeConverter(callConverters       : IReadOnlyDictionary<Symbol, seq<CallConverter>>, 
    ...
    static member DefaultNodeConverter = 
        ...
        let callConverters = Seq.ofArray [|
                                             ...
                                             makePair CodeSymbols.New ExpressionConverters.InitializedTypedArrayConverter;
                                             makePair CodeSymbols.New ExpressionConverters.InitializedAutoArrayConverter;
                                             ...
                                             makePair CodeSymbols.Of ExpressionConverters.GenericInstanceConverter;
        ...
        let typeMemberConverters =  [|
                                        ...
                                        CodeSymbols.Constructor, MemberConverters.MethodDeclarationConverter MemberConverters.ConvertConstructorDeclaration
